...
const Header = () => {
 ...
 <div className="flex justify-between items-center py-3">
      ...
      <div className="control-btn flex gap-2">
        <div id="searchBar" className="border border-neutral-600 h-12 w-60 flex gap-3 px-2 items-center opacity-0 -translate-y-full">
        ...
        <button className="border border-neutral-600 duration-100 active:scale-90 h-12 w-12 flex justify-center items-center" id="searchBtn">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5 stroke-1">
